...
1. `TUTOR_EMAIL`과 일치하는 Google 계정으로 로그인합니다. 이 계정은 모든 수업에 접근하는 통합 운영자입니다. **전체 수업 관리**에서 수업 이름과 새 튜터의 Google 이메일·이름을 입력하면 같은 10주 형식의 새 공간이 만들어집니다. 새 튜터는 그 Google 계정으로 로그인해 자기 공간만 관리합니다.
