...
export type Week = { id: number; date: string; time: string; duration: number; location: string; topic: string; concepts: string; published: boolean; cleared: boolean; sessionParts: SessionPart[]; reportMemberId?: string; progressMaterialId?: string; progressLabel?: string; progressPage?: number; actualDate?: string };
...
export type ReportGuide = { id: string; kind: 'template' | 'in-person' | 'online'; name: string; size: number; updatedAt: string; ext?: 'pdf' | 'docx' };
