...
const en:Record<string,string>={
  ...
  '날짜':'Date','시간':'Time','길이(분)':'Duration (minutes)','수업 길이':'Session length','장소':'Venue','주제':'Topic','핵심 개념':'Key concepts','보고서 담당자':'Report writer','이번 주차 완료로 표시 (지도에 반영)':'Mark this week complete on the map','팀원에게 이 주차 공개':'Publish this week to the team','일정 저장':'Save schedule','학습자료와 진도':'Materials & progress','현재 진도:':'Current progress:','PDF 올리기':'Upload PDF','파일 올리기':'Upload file','양식 파일(DOCX)을 내려받아 작성하고, 작성 예시를 함께 확인해 주세요.':'Download the DOCX form to fill in, and check the examples too.','제출 방법':'How to submit','사이버캠퍼스 → 튜터링 → 팀별게시판':'Cyber Campus → Tutoring → Team board','제목':'Post title','내용은 비우고 파일 첨부':'Leave the body empty and attach the file','파일명':'File name','제목 복사':'Copy title','파일명 복사':'Copy file name','양식대로 채우기':'Fill in the official form','진도 자료':'Material covered','목록에 없으면 직접 입력':'Not listed? Type it in','마지막 페이지':'Last page reached','진도 기록':'Save progress','공개':'Published','잠정':'Tentative','미정':'TBA','시간 미정':'Time TBA','선택':'Select','자료':'Material','담당자 미정':'Writer TBD','날짜 미정':'Date TBD','보고서 담당자 미정':'Report writer TBD',
  ...
  '보고서 양식과 작성 예시':'Report form & examples','양식과 예시를 확인한 뒤 이번 주 보고서를 작성해 주세요.':'Review the form and examples before writing this week’s report.','작성 양식':'Blank form','대면 작성 예시':'In-person example','비대면 작성 예시':'Online example','자료 준비 중':'Coming soon','미리보기':'Preview','다운로드':'Download','교체':'Replace','보고서 자료를 등록했습니다.':'Report guide uploaded.',
};
